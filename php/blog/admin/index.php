...
$posts = $postControler->getallPosts($page_size, $page, getUserId(), $q, $order_field, $order_by );
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href="<?= getSortingUrl('title', $order_field, $order_by, $q) ?>">Author <?= getSortFlag('u.name', $order_field, $order_by) ?></a></th>
