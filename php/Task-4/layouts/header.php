                        ...
                        ?>
                            ...
                            ?>
                             <li class="nav-item dropdown">
                                ...
                                <a class="dropdown-item" href="<?=BASE_URL?>\admin\index.php">Posts</a>
                                <a class="dropdown-item" href="<?=BASE_URL?>\admin\users.php">users</a>
                                </div>
                            </li>
                            <?php
                            }
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?=BASE_URL?>\myPosts\posts.php">My Posts</a>
                            </li>
                            <li class="nav-item">
