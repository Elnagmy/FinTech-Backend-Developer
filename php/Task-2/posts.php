               ...
               ?>
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <a href="post-details.php"><h4><?= $post->title ?></h4></a>
                      <ul class="post-info">
                        <li><a href="<?= 'posts.php?user_id='.$post->author->id ?>"><?=$post->author->name ?></a> </li>
                        <li><a href="#"><?=$post->publish_date ?></a></li>
                        <li><a href="#"><?=$post->commentsCont ?></a></li>
                      </ul>
                      <p><?=$post->content ?></p>
                ...
                <div class="col-lg-12">
                  <ul class="page-numbers">
                    ...
                    <?php } ?>
                    <?php 
                      if ( $page + MAX_PAGINATION_PAGES < $numberOfpages  ){
                    ?>
