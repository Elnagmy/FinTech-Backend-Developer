...
function getUrl($page, $q, $order_field, $order_by)
{
    ...
    return "myposts.php?page=$page&q=$q&order_field=$order_field&order_by=$order_by";
}
function getSortingUrl($field, $oldOrderField, $oldOrderBy, $q)
{
   
    if ($field == $oldOrderField && $oldOrderBy == 'asc') {
        return "myposts.php?page=1&q=$q&order_field=$field&order_by=desc";
    }
    if ($field == $oldOrderField && $oldOrderBy == 'desc') {
        return "myposts.php?page=1&q=$q";
    }
    return  "myposts.php?page=1&q=$q&order_field=$field&order_by=asc";
}
...
$posts = $postControler->getMyPosts($page_size, $page, getUserId(), $q, $order_field, $order_by);
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($posts['data'] as $post) {
                                    ...
                                    <td>
                                    <a href='edit.php?post_id={$post->id}' class='btn btn-primary'>Edit</a>
